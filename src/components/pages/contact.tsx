import { ContactIcon, FlagIcon, MailIcon, MapPinIcon, PhoneIcon } from 'lucide-react';
import { useIntlayer, useLocale } from 'react-intlayer';
import { GABON_WIKI_EN, GABON_WIKI_FR, getResumeUrl } from '@/config/constants';
import { FlagGa } from '@/components/flags';
import { MotionDiv } from '../atom';

export const ContactCard = () => {
  const t = useIntlayer('contact');
  const { locale } = useLocale();
  const wikiUrl = locale === 'fr' ? GABON_WIKI_FR : GABON_WIKI_EN;

  return (
    <div className="min-h-screen flex items-start bg-primary py-20" id="contact">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-10 tablet:mb-0">
            <MotionDiv className="flex gap-3 items-center">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <a href="tel:+250791901792" className="text-primary-foreground font-mono">
                  +250 791 901 792
                </a>
              </div>
            </MotionDiv>
            <MotionDiv className="flex gap-3 items-center">
              ...
              <div className="flex-1 flex flex-col">
                ...
                <a href="mailto:sergemezui.dev@gmail.com" className="text-primary-foreground">
