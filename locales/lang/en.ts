...
export default {
  ...
  skill: {
    ...
    description: "I'm an autonomous, creative and professional developer. Passionate about backend work (database administration, API design, server administration...) I can also take on front-end tasks (web integration, ...) or model building.",
    techno: "Technos",
    skills: {
      design: {
        title: "Design",
  ...
  project: {
    title: "My Projects",
    question: "What did you already done?",
    visit: "Visit",
    projects: {
      transitup: {
        name: "Transit'Up",
  ...
  contact: {
    ...
    from: "From Africa",
    resume: "My Resume",
    open_resume: "click to open resume",
  },
  footer: {
    powered: "Powered By",
  },
